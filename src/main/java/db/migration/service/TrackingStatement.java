...
import db.migration.service.modyfication.create.CreateTable;
 ...
 * @since 16.06.2017
 */
public class TrackingStatement implements Statement {

    private Statement statement;
    private DBChangeTracker tracker;

    public TrackingStatement(Statement statement, DBChangeTracker tracker) {
